      ...
      <div className="max-w-[1280px] mx-auto px-6 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-[#A0A0A0]">
              ...
              <li className="flex items-center gap-1.5"><Activity className="w-3 h-3 text-[#0C8B44]" /> Real-Time Status</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 pt-6 border-t border-[#ffffff05]">
          ...
          <div className="flex items-center gap-4 text-[11px] text-[#737373] flex-wrap justify-center">
            ...
            <Link to="/disclosures" className="hover:text-[#A0A0A0] transition-colors">Disclosures</Link>
            <Link to="/status" className="hover:text-[#A0A0A0] transition-colors">Status</Link>
